...
class WisudaWisudawan extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'wwNim' => 'NIM',
            'wwNoAlumni' => 'No Alumni',
            'wwIdSkripsi' => 'Id Skripsi',
            'wwNik' => 'Ww Nik',
            'wwNama' => 'Nama Lengkap',
            'wwGlrDepan' => 'Ww Glr Depan',
            'wwGlrBelakang' => 'Ww Glr Belakang',
            'wwJenkel' => 'Ww Jenkel',
            'wwTmpLahir' => ' Tmp Lahir',
            'wwTglLahir' => 'Ww Tgl Lahir',
            'wwTglLahirText' => 'Tgl Lahir ',
            'wwEmail' => ' Email',
            'wwHp' => 'Ww Hp',
            'wwKabId' => 'Ww Kab ID',
            'wwAlamat' => 'Ww Alamat',
            'wwPendTerakhir' => ' Pend Terakhir',
            'wwAngkatan' => ' Angkatan',
            ...
            'wwJalurNama' => ' Jalur Masuk',
            'wwIsBidikmisi' => 'Ww Is Bidikmisi',
            'wwDosenPa' => 'Ww Dosen Pa',
            'wwJudulTa' => 'Judul Skripsi/TA/Thesis',
            'wwIsNoTa' => 'Ww Is No Ta',
            'wwTglMulaiBimb' => ' Tgl Mulai Bimbingan',
            'wwTglSelesaiBimb' => ' Tgl Selesai Bimbingan',
            'wwLamaStudiThn' => 'Lama Tahun Studi',
            'wwLamaStudiBln' => 'Lama Bulan Wisuda',
            'wwThnWisuda' => 'Tahun Wisuda',
            'wwTglLulus' => 'Tanggal Lulus',
            'wwIPK' => 'IPK',
            'wwPredikatId' => 'Ww Predikat ID',
            'wwScoreToefl' => 'Score Toefl',
