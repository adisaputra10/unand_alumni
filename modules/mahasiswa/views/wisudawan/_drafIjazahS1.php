    ...
    <div class="draf-ijazah">
        ...
        <div class="ijazah-content">
            ...
            <div class="paragraf">
                ...
                pada Program Studi <span style="background-color: yellow"><?php echo strtoupper($result['prodiNama']); ?></span> lulus pada tanggal <span style="background-color: yellow"><?php echo $inDate->setDate($result['wwTglLulus']); ?></span>, oleh sebab itu kepadanya diberikan gelar<br/>
                <h3><span style="background-color: yellow"><?php echo $result['prodiGelarLulusan']; ?></span></h3>
                <br/>
                beserta segala hak dan kewajiban yang melekat pada gelar tersebut.<br/><br/>
