                        ...
                        echo Form::widget([
                            ...
                            'attributes' => [
                                ...
                                'item_32' => [
                                    ...
                                    'columnOptions' => ['rowspan' => 1],
                                    'attributes' => [
                                        //'wwSapsPredikat' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => 'Predikat SAPS'], 'columnOptions' => ['colspan' => 1], 'hint' => 'Isi dengan predikat di sertifikat SAPS'],
                                        ...
                                        'wwSapsLamp' => ['type' => Form::INPUT_FILE, 'options' => ['placeholder' => 'Sertifikat SAPS'], 'columnOptions' => ['colspan' => 1], 'hint' => 'Ukuran maksimum 200kb, format .PDF'],
                                        'lampiran' => ['type' => Form::INPUT_RAW, 'value' => empty($model->wwSapsLamp) ? '' : Html::a(' Sertifikat SAPS', Url::to(['download', 'filename' => $model->wwSapsLamp]), ['target' => '_blank', 'class' => 'label label-info fa fa-paperclip', 'style' => 'margin-left:15px;']) . '<div class="hint-block">Untuk mengganti file cukup dengan mengupload ulang foto pengganti</div>', 'columnOptions' => ['colspan' => 1]]
                                    ]
                                ],
                            ]
                        ]);
