    ...
    <div class="draf-ijazah">
        ...
        <div class="ijazah-content">
            ...
            <div class="paragraf">
                ...
                Profesional pada Program Studi <span style="background-color: yellow"><?php echo strtoupper($result['prodiNama']); ?></span> lulus pada tanggal <span style="background-color: yellow"><?php echo $inDate->setDate($result['wwTglLulus']); ?></span>, oleh sebab itu kepadanya diberikan sebutan<br/>
