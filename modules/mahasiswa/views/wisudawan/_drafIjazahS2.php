    ...
    <div class="draf-ijazah">
        ...
        <div class="ijazah-content">
            ...
            <div class="paragraf">
                ...
                pada Program Studi <span style="background-color: yellow"><?php echo strtoupper($result['prodiNama']); ?></span> Program Pascasarjana <span style="background-color: yellow"><?php echo $result['fakNama']; ?></span> lulus pada tanggal <span style="background-color: yellow"><?php echo $inDate->setDate($result['wwTglLulus']); ?></span>, oleh sebab itu kepadanya diberikan gelar<br/>
