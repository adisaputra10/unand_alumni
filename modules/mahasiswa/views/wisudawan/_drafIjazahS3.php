    ...
    <div class="draf-ijazah">
        ...
        <div class="ijazah-content">
            ...
            <div class="paragraf">
                ...
                pada Program Doktor Bidang <span style="background-color: yellow"><?php echo ucwords(strtolower($result['prodiNama'])); ?></span> dengan judul disertasi :<br/>
                <div style="background-color: yellow;text-align: center;font-weight: bold;margin:0px;padding:0px;"><?php echo Html::decode($result['wwJudulTa']); ?></div>
                lulus pada tanggal <span style="background-color: yellow"><?php echo $inDate->setDate($result['wwTglLulus']); ?></span> dengan predikat <span style="background-color: yellow"><?php echo $result['predikatNama'] ?></span>, oleh sebab itu kepadanya diberikan gelar<br/>
                <h3><span style="background-color: yellow"><?php echo $result['prodiGelarLulusan']; ?></span></h3>
                <br/>
                beserta segala hak dan kewajiban yang melekat pada gelar tersebut.<br/><br/><br/>
